...
export class GroupchatComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.bmessages = this.afs.collection('groupchat').valueChanges({idField:'id'}).pipe(map(combined => combined.sort(this.compFn)));
    this.fmessages = this.afs.collection('groupchat', ref =>
    ref.where('userLevel', '==', 'Farmer')).valueChanges({idField:'id'}).pipe(map(combined => combined.sort(this.compFn)));
